...
const Header = () => {
  ...
  return (
      ...
      >
        <nav className="w-full px-4 py-4">
          ...
          <button
            ...
            className={`md:hidden flex-shrink-0 inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 z-10 ml-auto ${
              isMobileMenuOpen
    ...
    {/* Mobile Navigation - Outside header to avoid overflow issues */}
    {isMobileMenuOpen && (
      <>
        {/* Backdrop */}
        <div 
        ...
        {/* Mobile Menu */}
        <div className={`fixed top-20 left-0 right-0 w-full md:hidden shadow-2xl z-[95] max-h-[calc(100vh-80px)] overflow-y-auto transition-all duration-300 ${
          isScrolled 

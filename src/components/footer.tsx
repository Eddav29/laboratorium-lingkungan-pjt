...
export default function Footer() {
  return (
    <footer className="bg-slate-900 text-white">
      <div className="w-full flex justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="w-full max-w-5xl flex flex-col sm:flex-col md:flex-row md:justify-center md:items-start gap-8 sm:gap-10 md:gap-16 text-left">
          {/* Info Kontak */}
          <div className="flex-1 min-w-[200px] sm:min-w-[240px] md:min-w-[220px] space-y-4">
            <h3 className="text-lg font-bold text-white mb-4">Info Kontak</h3>
            <div className="space-y-3 max-w-[250px] md:mx-0">
              <div className="flex items-start justify-start space-x-3">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="text-left">
                  ...
                  <a 
                    ...
                    className="text-gray-300 text-xs hover:text-white transition-colors duration-300 break-words"
                  >
              ...
              <div className="flex items-start justify-start space-x-3">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex-1 min-w-[200px] sm:min-w-[240px] md:min-w-[220px] space-y-4">
            ...
            <div className="space-y-2 max-w-[250px] md:mx-0">
              <a
                href="/services/air"
                className="block text-gray-300 hover:text-blue-400 hover:translate-x-1 transition-all duration-300 text-xs break-words"
              >
